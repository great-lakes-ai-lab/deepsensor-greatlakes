...
| **Dataset Name**         | **Description**                                              | **Data Path**                                                       | **Format** | **Consolidated** | **Variables**                            | **Time Range**           |
|--------------------------|--------------------------------------------------------------|--------------------------------------------------------------------|------------|------------------|------------------------------------------|--------------------------|
| **glos surface temps**              | Great Lakes Observing System (GLOS) surface temps      | /nfs/turbo/seas-dannes/SST-sensor-placement-input/GLOS/gl_temp_data_cleaned.nc                        | NetCDF       | No               | sst, lat, lon, time                 | 2012 to 2025 |
